    ...
    <footer className='bg-white  w-full py-8 mt-8'>
      <div className='max-w-screen-xl mx-auto px-4'>
        <div className=' flex max-w-xs mx-auto items-center justify-between'>
          <a
            href='https://www.facebook.com/mostofa.rajon11'
          ...
          <a
            href='https://twitter.com/MostofaRajon'
            className='text-gray-400 hover:text-gray-800 transition-colors duration-200'
          >
            <svg
              width='20'
          ...
          <a
            href='https://github.com/rajon111/'
            className='text-gray-400 hover:text-gray-800 transition-colors duration-200'
          >
            <svg
              xmlns='http://www.w3.org/2000/svg'
          ...
          <a
            href='https://www.linkedin.com/in/golam-mostofa-rajon-8906781b1/'
            className='text-gray-400 hover:text-gray-800 transition-colors duration-200'
          >
            <svg
              width='20'
